...
//    });
    ...
    // more cleave for country codes only
    ...
    //secondary phone number cleave ultimate
    var selectCountryAlt = $('.select-country-alt');
    selectCountryAlt.html(html);
    selectCountryAlt.val('+1');
    
    var cleavePhoneAlt = new Cleave('.input-phone-alt', {
        phone:           true,
        phoneRegionCode: 'CA'
    });
    
    selectCountryAlt.on('change', function () {
        cleavePhoneAlt.setPhoneRegionCode(this.value);
        cleavePhoneAlt.setRawValue(this.value);
